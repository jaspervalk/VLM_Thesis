...
TRANSFORMS_ROOT="./transforms_reduction/trainset_100pct"

OUT_DIR="test_fewshot_results_reduction_100pct"

echo "Running 5-shot classification on $DATASET with $MODEL using gLocal (0.01% triplets)..."
