...
# TRANSFORMS_ROOT="./features/cifar100/results/custom/CLIP_ViT-L-14_WIT/penultimate/sgd/0.001/0.001/0.1/1.0/1024/transform.npz"
THINGS_EMBEDDINGS="./features/things/embeddings/model_features_per_source.pkl"
OUT_DIR="fewshot_results"
# CORRECT
TRANSFORMS_ROOT="./features/cifar100/results"
...
if [ ! -f "$EXPECTED_TRANSFORM_PATH/transform.npz" ]; then
  echo "ERROR: transform.npz not found in expected path: $EXPECTED_TRANSFORM_PATH"
  exit 1
fi
