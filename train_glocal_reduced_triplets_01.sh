...
TRIPLET_FILE="triplet_dataset/trainset_0_1pct.npy"
TRIPLET_NAME=$(basename "$TRIPLET_FILE" .npy)
LOG_DIR="./transforms_reduction/$TRIPLET_NAME"
...
FEATURES_FORMAT="pt"  # FIXED from "pt" → "pkl"
NUM_PROCESSES=4
RND_SEED=42


mkdir -p "$LOG_DIR"
echo "Running few-shot classification on $DATASET with $MODEL using gLocal (0.01% triplets)..."
